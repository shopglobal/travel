...
class FlightSearchPrice(object):
    ...
    def __init__(self, total_price=None, price_per_adult=None, price_per_child=None, price_per_infant=None, restrictions=None):
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FlightSearchPrice):
            return False
